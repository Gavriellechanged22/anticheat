...
if(NOT DEFINED AC_CASE)
    message(FATAL_ERROR "AC_CASE must select one CLI contract")
endif()

file(REMOVE_RECURSE "${AC_WORKING_DIRECTORY}")
file(MAKE_DIRECTORY "${AC_WORKING_DIRECTORY}")

if(AC_CASE STREQUAL "version")
    execute_process(
...
elseif(AC_CASE STREQUAL "version_conflict")
    execute_process(
        COMMAND
            "${AC_EXECUTABLE}"
            --version
...
elseif(AC_CASE STREQUAL "help")
    ...
    message(FATAL_ERROR "unknown CLI contract: ${AC_CASE}")
endif()

if(EXISTS "${AC_WORKING_DIRECTORY}/anticheat-events.jsonl")
    message(FATAL_ERROR "${AC_CASE} created the default log file")
endif()
